...
const GAME_CONFIG = {
    ...
    ACHIEVEMENTS: [
        ...
        { id: 'guard_1', category: 'guard', statPath: 'guardTripsTotal', threshold: 20000, bonusPercent: 0.005, rewardShares: 15, icon: '<img src="images/guard_circle.png" class="achievement-img" alt="Guard" />', i18nKey: 'guard_1' },
